        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm p-4 mb-4">
                ...
                @if($pengajuan->status == 'baru')
                    <div class="alert alert-secondary">Pengajuan telah dikirim dan sedang menunggu verifikasi.</div>
                ...
                @elseif($pengajuan->status == 'diterima')
                    <div class="alert alert-success">Surat sudah disetujui.</div>
                @else
                    <div class="alert alert-danger">Pengajuan ditolak.</div>
                @endif
