...
<body>
    <div class="auth-card">
        ...
        <div class="auth-form">
            <h2>Masuk ke RT/RW</h2>
            <p class="subtitle">Masukkan email dan kata sandi Anda untuk mengakses dashboard.</p>
            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label label-auth" for="loginEmail">Email</label>
                    <div class="input-group input-group-auth">
                        <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                        <input type="email" name="email" value="{{ old('email') }}" class="form-control" id="loginEmail" placeholder="name@example.com" required autofocus>
                    </div>
                </div>

                <div class="mb-4">
                    <label class="form-label label-auth" for="loginPassword">Password</label>
                    <div class="input-group input-group-auth">
                        <span class="input-group-text"><i class="bi bi-shield-lock"></i></span>
                        <input type="password" name="password" class="form-control" id="loginPassword" placeholder="Kata sandi" required>
                    </div>
                </div>
